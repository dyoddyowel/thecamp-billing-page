  ...
  return(
    <div id="thank-you-container">
      ...
      <div id="thank-you-image-wrapper">
        <div><a href="/Fall-Back-Into-Fitness-21-Day-Detox-Manual.pdf" download><button>Download the Fall Back Into Fitness 21 Day Detox Program Manual</button></a></div>
      </div>
    </div>
  );
}
